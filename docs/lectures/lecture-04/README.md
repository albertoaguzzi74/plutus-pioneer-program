...
Congratulations on completing Lecture 3 of the Plutus Pioneers Program (PPP)! In this lecture, you'll learn more about off-chain code in smart contracts. We are so excited to have you moving forward on your learning journey and to see what you accomplish with the next lesson. So, let's begin Lecture 4!
